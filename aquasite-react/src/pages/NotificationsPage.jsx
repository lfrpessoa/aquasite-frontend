...
const NotificationsPage = () => {
  ...
  const loadNotifications = async () => {
    setLoading(true)
    try {
      const res = await fetch(`https://aquasite-main-1.onrender.com/api/notifications/${currentUser}`)
      const data = await res.json()
      setNotifications(Array.isArray(data) ? data : [])
      await fetch(`https://aquasite-main-1.onrender.com/api/notifications/${currentUser}/read`, { method: 'PUT' })
    } catch {}
    setLoading(false)
  }
